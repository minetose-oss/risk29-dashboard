      ...
      <div className="max-w-7xl mx-auto">
            ...
            <div className="inline-flex flex-col gap-1 min-w-full">
                ...
                {weeks.map((week, weekIndex) => (
                  <div key={weekIndex} className="flex gap-1">
                    {week.map((day, dayIndex) => {
                      ...
                      return dayIndex === 0 ? (
                        <div key={day.date} className="w-3 text-[8px] text-zinc-500 text-center">
                          {date.getDate()}
                        </div>
                      ) : (
              ...
              {['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map((dayName, dayOfWeek) => (
                <div key={dayName} className="flex gap-1 items-center">
                  <div className="w-8 text-[10px] text-zinc-500">{dayName}</div>
                  {weeks.map((week, weekIndex) => {
        ...
        <Card className="p-6 bg-zinc-900/50 border-zinc-800 mb-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div key={item.sector} className="flex items-center justify-between p-4 bg-zinc-800/50 rounded-lg">
                <div>
                  <div className="font-medium">{item.sector}</div>
                  <div className="text-sm text-zinc-400">{item.trend}</div>
                </div>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-red-500/10 border border-red-500/20 rounded-lg">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="text-sm text-zinc-400">Oct 25-29, 2025</div>
              </div>
            ...
            <div className="p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="text-sm text-zinc-400">Oct 15-18, 2025</div>
              </div>
              <div className="text-sm text-zinc-300">
            ...
            <div className="p-4 bg-green-500/10 border border-green-500/20 rounded-lg">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="text-sm text-zinc-400">Oct 1-10, 2025</div>
              </div>
              <div className="text-sm text-zinc-300">
        ...
        <div className="grid md:grid-cols-4 gap-4 mt-6">
          {[
            ...
            return (
              <Card key={stat.label} className="p-4 bg-zinc-900/50 border-zinc-800">
